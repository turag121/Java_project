...
public class bekcart extends JFrame implements ActionListener {
    ...
    public bekcart(String user, int totalb) {
        super("");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         this.user = user;
         this.groprice=totalb;
    ...
    private void createTable() {
        ...
        tableModel.addRow(new Object[]{"BAKERY",groprice });
