...
public class meatcart extends JFrame implements ActionListener {
    ...
    public meatcart(String user, int totalmeat) {
        super("");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         this.user = user;
         this.groprice=totalmeat;
    ...
    private void createTable() {
        ...
        tableModel.addRow(new Object[]{"MEAT",groprice });
