...
public class medcart extends JFrame implements ActionListener {
    ...
    public medcart(String user, int totalm2) {
        super("");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         this.user = user;
         this.groprice=totalm2;
    ...
    private void createTable() {
        ...
        tableModel.addRow(new Object[]{"MEDICINE",groprice });
