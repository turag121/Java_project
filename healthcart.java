...
public class healthcart extends JFrame implements ActionListener {
    ...
    public healthcart (String user, int totalh) {
        super("");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         this.user = user;
         this.groprice=totalh;
    ...
    private void createTable() {
        ...
        tableModel.addRow(new Object[]{"HEALTH CARE",groprice });
