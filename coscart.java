...
public class coscart extends JFrame implements ActionListener {
    ...
    public coscart(String user, int totalc) {
        super("");
        this.setSize(900, 600);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         this.user = user;
         this.groprice=totalc;
    ...
    private void createTable() {
        ...
        tableModel.addRow(new Object[]{"COSMETICS",groprice });
